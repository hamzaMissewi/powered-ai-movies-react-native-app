...
const BaconDefaultTheme: Theme = {
  ...
  colors: {
    // ...DefaultTheme.colors,
    primary: AC.systemBlue.toString(),
    background: AC.systemGroupedBackground.toString(),
    card: AC.secondarySystemGroupedBackground.toString(),
    text: AC.label.toString(),
    border: AC.separator.toString(),
    notification: AC.systemRed.toString(),
  },
